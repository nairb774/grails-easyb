 ...
 * Call easyb plugins _GrailseasybTest script instead of grails default _GrailsTest.
 *
 * @author Graeme Rocher, Gustavo Madruga
 *
 * @since 0.4
 */

includeTargets << grailsScript("_GrailsClean")
includeTargets << new File("${easybPluginDir}/scripts/_GrailsEasybTest.groovy")
